 ...
 */
final class Version20230404100800 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE hangout (id INT AUTO_INCREMENT NOT NULL, creator_id INT NOT NULL, site_id INT NOT NULL, place_id INT NOT NULL, name VARCHAR(255) NOT NULL, start_timestamp DATETIME NOT NULL, duration VARCHAR(255) NOT NULL COMMENT \'(DC2Type:dateinterval)\', last_register_date DATE NOT NULL, max_slots INT NOT NULL, informations VARCHAR(3000) NOT NULL, state VARCHAR(50) NOT NULL, cancel_reason LONGTEXT DEFAULT NULL, is_published TINYINT(1) NOT NULL, INDEX IDX_20C5B31E61220EA6 (creator_id), INDEX IDX_20C5B31EF6BD1646 (site_id), INDEX IDX_20C5B31EDA6A219 (place_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, site_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, phone VARCHAR(20) DEFAULT NULL, active TINYINT(1) NOT NULL, administrator TINYINT(1) NOT NULL, username VARCHAR(50) NOT NULL, image_url VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), INDEX IDX_8D93D649F6BD1646 (site_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE hangout ADD CONSTRAINT FK_20C5B31E61220EA6 FOREIGN KEY (creator_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE hangout ADD CONSTRAINT FK_20C5B31EF6BD1646 FOREIGN KEY (site_id) REFERENCES site (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE hangout ADD CONSTRAINT FK_20C5B31EDA6A219 FOREIGN KEY (place_id) REFERENCES place (id) ON DELETE CASCADE');
